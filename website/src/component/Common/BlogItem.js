            ...
            <div className="col-lg-4 col-sm-6 mb-4">
                        <div className="portfolio-item">
                            <Link 
                                ...
                                onClick={e => this.props.setPostData(this.props.post)}//sets the particular blog item, so this appears unique to Single
                                >
                                ...
                                {this.props.post.PostImage ? 
                                    ...
                                    <img style={{width: '100%'}} className="img-fluid" src={API.makeFileURL(this.props.post.PostImage[0].thumbnail)} alt="" />
                                    : null
                                :null}
                            </Link>
